...
const adminInfoConfig = {
  ...
  url: 'https://admin.loveupay.in/api',
  ...
  allSmsUrl: 'http://18.162.131.251/BswFiopsF/phone/', // 短信web端界面: 总链接
}
